...
public class ScoutSheet {
	...
	private HBox top;
	private GridPane grid, lowBarGrid;
	private BorderPane border;
	private Label teamNumLab, defenseLab, aLabel;
	private TextField teamNumber;
	private ImageView lowBarView, portView, chevalView;
	...
	public ScoutSheet(){
		...
		GridPane.setConstraints(aLabel, 0, 3, 4, 1, HPos.CENTER, VPos.CENTER);
		GridPane.setConstraints(defenseLab, 0, 0, 4, 1, HPos.CENTER, VPos.CENTER);
		...
		GridPane.setConstraints(lowBarNotes, 0, 1, 2, 1, HPos.CENTER, VPos.CENTER);
		...
		grid.setVgap(10);
		grid.getChildren().addAll(defenseLab, lowBarGrid, aLabel);
